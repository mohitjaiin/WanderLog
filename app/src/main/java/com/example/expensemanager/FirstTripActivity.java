...
public class FirstTripActivity extends AppCompatActivity implements OnItemsCLick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.addIncome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FirstTripActivity.this, AddExpenseActivity.class);
        ...
        binding.addBills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FirstTripActivity.this, CameraMainActivity.class);
                startActivity(intent);
            }
        });
    }
            ...
            FirebaseAuth.getInstance()
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.cancel();
                            Toast.makeText(FirstTripActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
